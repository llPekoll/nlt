...
<div class ="">
    <div class="lock p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <button on:click={handleMint} class=" py-2 px-10 bg-red-600 text-white rounded-lg my-2 text-center mx-auto w-full">
            Mint
        </button>
