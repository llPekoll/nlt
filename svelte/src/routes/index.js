...
export async function get() {
	const trad = {
		...
		<svg  class="text-green-100" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			 viewBox="0 0 410.155 410.155"  xml:space="preserve">
		<path style="fill:#d1fae5" d="M403.632,74.18c-9.113,4.041-18.573,7.229-28.28,9.537c10.696-10.164,18.738-22.877,23.275-37.067
